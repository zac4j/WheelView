...
class ScrollerCompat implements WheelScroller {
  ...
  @Override public void abortAnimation() {
  ...
  @Override public void extendDuration(int extend) {
  ...
  @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) @Override public float getCurrVelocity() {
  ...
  @Override public int getFinalX() {
    return mScroller.getFinalX();
  }

  @Override public int getFinalY() {
    return mScroller.getFinalY();
  }

  @TargetApi(Build.VERSION_CODES.CUPCAKE) @Override public int getStartX() {
    return mScroller.getStartX();
  }

  @TargetApi(Build.VERSION_CODES.CUPCAKE) @Override public int getStartY() {
  ...
  @Override public void setFinalX(int newX) {
    mScroller.setFinalX(newX);
  }

  @Override public void setFinalY(int newY) {
    mScroller.setFinalY(newY);
  }

  @Override public boolean isOverScrolled() {
    throw new RuntimeException("ScrollerCompat not support this method.");
  }

  @Override public void notifyHorizontalEdgeReached(int startX, int finalX, int overX) {
    throw new RuntimeException("ScrollerCompat not support this method.");
  }

  @Override public void notifyVerticalEdgeReached(int startY, int finalY, int overY) {
    throw new RuntimeException("ScrollerCompat not support this method.");
  }

  @TargetApi(Build.VERSION_CODES.HONEYCOMB) @Override public void setFriction(float friction) {
  ...
  @Override public int timePassed() {
