...
import com.zac4j.wheelview.core.BaseWheelDecor;
import com.zac4j.wheelview.core.BaseWheelPicker;
...
public abstract class WheelCrossPicker extends BaseWheelPicker
  ...
  @Override protected void instantiation() {
    super.instantiation();
  ...
  @Override protected void drawBackground(Canvas canvas) {
  ...
  @Override protected void onTouchDown(MotionEvent event) {
